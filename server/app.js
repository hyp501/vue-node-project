...
var datasource="mysql";// file or mysql
...
app.post('/getItemById',bodyParser.json(),function(req,res){
    if(!checkSign(req,res)){
        return
    }
    if(datasource=='file'){
    ...
    {
        databaseManger.getItemById(req,res);
    }
})
app.post('/deleteItem',bodyParser.json(),function(req,res){
    if(!checkSign(req,res)){
        return
    }
    if(datasource=='file'){
    ...
    {
        databaseManger.deleteItem(req,res);
    }
})
